...
import os, sys
PYTHON = sys.executable    # for lp2e, 'python' of iff on path
...
if answer not in ['y', 'Y', 'yes']:
    ...
    os.chdir(os.pardir)    # for lp2e, hack: go up one level
    os.system('%s tools%sfixeoln_all.py tounix' % (PYTHON, os.sep))
