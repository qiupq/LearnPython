...
# for the screen; still to do: (1) rearrange tumbnails when 
...
class ViewOne(Toplevel):
    """
    open a single image in a popup window when created;
    ...
    code is factored to avoid redundacy here as possible;
    """ 
...
def onDirectoryOpen(event):
    """
    open a new image directory in new popup
