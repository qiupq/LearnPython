...
# where this script is run; this assumes a Unix-like find command, and 
# so is very non-portable; we could instead use the Python find module,
# or just walk the directry trees with portable Python code; the find
