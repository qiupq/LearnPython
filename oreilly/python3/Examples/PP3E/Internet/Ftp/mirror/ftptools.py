...
# invoke both an upload and download;  for the uploadall varient and possibly
...
class FtpTools:
    ...
    def connectFtp(self):
        ...
        connection.login(self.remoteuser, self.remotepass) # login as user/pswd
    ...
    def downloadDir(self):
        ...
        for remotename in remotefiles:
            ...
            print 'downloading', remotename, 'to', localpath, 'as',
